...
const AddProductForm: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (validateForm()) {
      ...
      // Envoie et traitement des données via API
  ...
  return (
    <form
      ...
      className="space-y-6 bg-gray-800 p-6 rounded-lg shadow-lg max-w-lg mx-auto"
    >
      <div>
        <label
          htmlFor="itemName"
      ...
      <button
        type="submit"
        disabled={submitting}
        className={`w-full bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 px-4 rounded-lg ${
